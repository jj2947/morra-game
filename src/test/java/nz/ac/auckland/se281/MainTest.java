...
public class MainTest {
  ...
  public static class Task1 extends CliTest {
    ...
    @Test
    public void T1_11_new_game() throws Exception {
      runCommands(NEW_GAME + " EASY 1", "Bob");
      assertContains(WELCOME_PLAYER.getMessage("Bob"));
      assertContains(END.getMessage());
    }

    // MARKING
    @Test
    public void T1_12_play_start_round() throws Exception {
      runCommands(
          NEW_GAME + " EASY 1",
          "Alice",
          //
          PLAY,
          "5 5");
      assertContains(WELCOME_PLAYER.getMessage("Alice"));
    ...
    @Test
    public void T1_13_play_ask_for_input() throws Exception {
      runCommands(
          NEW_GAME + " EASY 1",
          "Alice",
          //
    ...
    @Test
    public void T1_14_play_ask_for_input_wrong_sum_and_fingers() throws Exception {
      runCommands(
          NEW_GAME + " EASY 1",
          "Bob",
          //
    ...
    @Test
    public void T1_15_play_ask_for_input_wrong_fingers() throws Exception {
      runCommands(
          NEW_GAME + " EASY 1",
          "Alice",
          //
    ...
    @Test
    public void T1_16_play_ask_for_input_ok() throws Exception {
      runCommands(
          NEW_GAME + " EASY 1",
          "Alice",
          //
      ...
      assertContains(START_ROUND.getMessage("1"));
      assertContains(ASK_INPUT.getMessage());
      int[] res = MainTest.getPlay(1, "Alice", getCaptureOut());
      assertEquals(4, res[0]);
      assertEquals(4, res[1]);
    }

    @Test
    public void T1_17_play_ask_for_input_ok2() throws Exception {
      runCommands(
          NEW_GAME + " EASY 1",
          "Bob",
          //
      ...
      assertContains(START_ROUND.getMessage("1"));
      assertContains(ASK_INPUT.getMessage());
      int[] res = MainTest.getPlay(1, "Bob", getCaptureOut());
      assertEquals(1, res[0]);
      assertEquals(10, res[1]);
    }

    @Test
    public void T1_18_play_ask_for_input_ok_not_valid_two_rounds() throws Exception {
      runCommands(
          NEW_GAME + " EASY 2",
          "Alice",
          //
      ...
      assertEquals(3, res[0]);
      assertEquals(1, res[1]);
      res = MainTest.getPlay(2, "Alice", getCaptureOut());
      assertEquals(5, res[0]);
      assertEquals(10, res[1]);
    }

    @Test
    public void T1_19_play_ask_for_input_two_rounds_second_wrong() throws Exception {
      runCommands(
          NEW_GAME + " EASY 3",
          "Bob",
          //
      ...
      assertEquals(3, res[0]);
      assertEquals(1, res[1]);
      res = MainTest.getPlay(2, "Bob", getCaptureOut());
      assertEquals(5, res[0]);
      assertEquals(10, res[1]);
      res = MainTest.getPlay(3, "Bob", getCaptureOut());
    ...
    @Test
    public void T1_20_play_ask_for_input_two_rounds_second_wrong_many_times() throws Exception {
      runCommands(
          NEW_GAME + " EASY 1",
          "Valerio",
          //
  ...
  public static class Task2 extends CliTest {
    ...
    @Test
    public void T2_07_play_ask_for_input_Jarvis() throws Exception {
      runCommands(
          NEW_GAME + " EASY 1",
          "Bob",
          //
    ...
    @Test
    public void T2_08_play_ask_for_input_Jarvis_random_seed() throws Exception {
      Utils.random = new java.util.Random(8);
      runCommands(
          NEW_GAME + " EASY 1",
          "Valerio",
          //
    ...
    @Test
    public void T2_09_play_ask_for_input_Jarvis_random_seed_two_rounds() throws Exception {
      Utils.random = new java.util.Random(6);
      runCommands(
          NEW_GAME + " EASY 2",
          "Valerio",
          //
    ...
    @Test
    public void T2_10_play_ask_for_input_Jarvis_random_seed_human_wins() throws Exception {
      Utils.random = new java.util.Random(7);
      runCommands(
          NEW_GAME + " EASY 1",
          "Valerio",
          //
      ...
      assertEquals(7, sumJarvis);
      assertContains(PRINT_OUTCOME_ROUND.getMessage("HUMAN_WINS"));
      assertDoesNotContain(PRINT_OUTCOME_ROUND.getMessage("DRAW"));
      assertDoesNotContain(PRINT_OUTCOME_ROUND.getMessage("AI_WINS"));
    }

    @Test
    public void T2_11_play_ask_for_input_Jarvis_random_seed_jarvis_wins() throws Exception {
    ...
    @Test
    public void T2_12_play_ask_for_input_Jarvis_random_seed_draw() throws Exception {
      Utils.random = new java.util.Random(9);
      runCommands(
          NEW_GAME + " EASY 1",
          "Valerio",
          //
  ...
  public static class Task3 extends CliTest {
    ...
    @Test
    public void T3_07_play_ask_for_input_Jarvis() throws Exception {
      runCommands(
          NEW_GAME + " MEDIUM 1",
          "Bob",
          //
    ...
    @Test
    public void T3_08_play_ask_for_input_Jarvis_random_seed() throws Exception {
      Utils.random = new java.util.Random(2);
      runCommands(
          NEW_GAME + " MEDIUM 1",
          "Alice",
    ...
    @Test
    public void T3_09_play_ask_for_input_Jarvis_random_seed_two_rounds() throws Exception {
      Utils.random = new java.util.Random(9);
      runCommands(
          NEW_GAME + " MEDIUM 2",
          "Valerio",
    ...
    @Test
    public void T3_10_play_ask_for_input_Jarvis_random_seed_three_rounds() throws Exception {
      Utils.random = new java.util.Random(7);
      runCommands(
          NEW_GAME + " MEDIUM 3",
          "Valerio",
    ...
    @Test
    public void T3_11_play_ask_for_input_Jarvis_random_seed_four_rounds() throws Exception {
      Utils.random = new java.util.Random(2);
      runCommands(
          NEW_GAME + " MEDIUM 3",
          "Valerio",
      ...
      // with four rounds, the average should start!
      // expected average is
      // 1 + 1 + 1 =3 [of course Jarvis cannot cheat, he does not know that the current finger is 4]
      // 3/3 = 1
      // rounded is 1
    ...
    @Test
    public void T3_12_play_ask_for_input_Jarvis_random_seed_five_rounds() throws Exception {
      Utils.random = new java.util.Random(20);
      runCommands(
          NEW_GAME + " MEDIUM 3",
          "Valerio",
          //
      ...
      // with four rounds, the average should start!
      // expected average is
      // 2 + 2 + 2 + 4 = 10 [of course Jarvis cannot cheat, he does not know that the current finger
      // is 5]
      // 10/4 = 2.5
      // rounded is 3
      // because the fingers that Jarvis randomly choose is 1 the sum should be 4 = 3 + 1
      assertEquals(1, fingersJarvis);
      assertEquals(4, sumJarvis);
    }
  }
  ...
  public static class Task4 extends CliTest {
    ...
    @Test
    public void T4_07_play_ask_for_input_Jarvis() throws Exception {
      runCommands(
          NEW_GAME + " HARD 1",
          "Valerio",
          //
    ...
    @Test
    public void T4_08_play_ask_for_input_Jarvis_random_seed() throws Exception {
      Utils.random = new java.util.Random(133);
      runCommands(
          NEW_GAME + " HARD 1",
          "Valerio",
          //
    ...
    @Test
    public void T4_09_play_ask_for_input_Jarvis_random_seed_two_rounds() throws Exception {
      Utils.random = new java.util.Random(31);
      runCommands(
          NEW_GAME + " HARD 2",
          "Valerio",
          //
    ...
    @Test
    public void T4_10_play_ask_for_input_Jarvis_random_seed_three_rounds() throws Exception {
      Utils.random = new java.util.Random(17);
      runCommands(
          NEW_GAME + " HARD 3",
          "Valerio",
          //
    ...
    @Test
    public void T4_11_play_ask_for_input_Jarvis_random_seed_four_rounds() throws Exception {
      Utils.random = new java.util.Random(245);
      runCommands(
          NEW_GAME + " HARD 3",
          "Valerio",
          //
    ...
    @Test
    public void T4_12_play_ask_for_input_Jarvis_random_seed_five_rounds() throws Exception {
      Utils.random = new java.util.Random(81);
      runCommands(
          NEW_GAME + " HARD 5",
          "Valerio",
          //
  ...
  public static class Task5 extends CliTest {
    ...
    // Marking
    @Test
    public void T5_07_play_ask_for_input_Jarvis() throws Exception {
      runCommands(
          NEW_GAME + " MASTER 1",
          "Valerio",
          //
    ...
    @Test
    public void T5_08_play_ask_for_input_Jarvis_random_seed() throws Exception {
      Utils.random = new java.util.Random(13);
      runCommands(
          NEW_GAME + " MASTER 1",
          "Valerio",
          //
    ...
    @Test
    public void T5_09_play_ask_for_input_Jarvis_random_seed_two_rounds() throws Exception {
      Utils.random = new java.util.Random(11);
      runCommands(
          NEW_GAME + " MASTER 2",
          "Valerio",
          //
    ...
    @Test
    public void T5_10_play_ask_for_input_Jarvis_random_seed_three_rounds() throws Exception {
      Utils.random = new java.util.Random(34);
      runCommands(
          NEW_GAME + " MASTER 3",
          "Valerio",
          //
    ...
    @Test
    public void T5_11_play_ask_for_input_Jarvis_random_seed_four_rounds() throws Exception {
    ...
    @Test
    public void T5_12_play_ask_for_input_Jarvis_random_seed_five_rounds() throws Exception {
      Utils.random = new java.util.Random(14);
      runCommands(
          NEW_GAME + " MASTER 5",
          "Valerio",
          //
  ...
  public static class Task6 extends CliTest {
    ...
    @Test
    public void T6_09_play_before_start() throws Exception {
      runCommands(
          NEW_GAME + " EASY 3",
          "Valerio",
          //
    ...
    @Test
    public void T6_10_start_game_twice() throws Exception {
      Utils.random = new java.util.Random(12);
      runCommands(
          NEW_GAME + " EASY 3",
          "Bob",
          //
    ...
    @Test
    public void T6_11_wins_one_round() throws Exception {
      Utils.random = new java.util.Random(1);
      runCommands(
          NEW_GAME + " HARD 1",
          "Alice",
      ...
      assertTrue(
          MainTest.getOutputByRound(1, getOutput())
              .contains(PRINT_OUTCOME_ROUND.getMessage("HUMAN_WINS")));
      assertContains(END_GAME.getMessage("Alice", "1"));
    }

    @Test
    public void T6_12_jarvis_wins_one_round() throws Exception {
      Utils.random = new java.util.Random(1);
      runCommands(
          NEW_GAME + " Medium 1",
          "Bob",
      ...
      assertTrue(
          MainTest.getOutputByRound(1, getOutput())
              .contains(PRINT_OUTCOME_ROUND.getMessage("AI_WINS")));
      assertDoesNotContain(END_GAME.getMessage("Bob", "1"));
      assertContains(END_GAME.getMessage("Jarvis", "1"));
    }

    @Test
    public void T6_13_human_wins_two_rounds() throws Exception {
      Utils.random = new java.util.Random(1);
      runCommands(
          NEW_GAME + " EASY 1",
          "Alice",
      ...
      assertTrue(
          MainTest.getOutputByRound(1, getOutput())
              .contains(PRINT_OUTCOME_ROUND.getMessage("DRAW")));
      assertDoesNotContain(END_GAME.getMessage("Alice", "1"));
      assertDoesNotContain(END_GAME.getMessage("Jarvis", "1"));
      assertTrue(
          MainTest.getOutputByRound(2, getOutput())
              .contains(PRINT_OUTCOME_ROUND.getMessage("HUMAN_WINS")));
      assertContains(END_GAME.getMessage("Alice", "2"));
      assertDoesNotContain(END_GAME.getMessage("Jarvis", "2"));
    }

    @Test
    public void T6_14_human_wins_two_rounds() throws Exception {
      Utils.random = new java.util.Random(1);
      runCommands(
          NEW_GAME + " EASY 2",
          "Bob",
      ...
      assertTrue(
          MainTest.getOutputByRound(2, getOutput())
              .contains(PRINT_OUTCOME_ROUND.getMessage("HUMAN_WINS")));
      assertContains(END_GAME.getMessage("Bob", "2"));
      assertDoesNotContain(END_GAME.getMessage("Jarvis", "2"));
    }

    @Test
    public void T6_15_show_stats_fail() throws Exception {
      Utils.random = new java.util.Random(1);
      runCommands(PLAY, SHOW_STATS);

      assertContains(GAME_NOT_STARTED.getMessage());
    }

    @Test
    public void T6_16_show_stats_ok() throws Exception {
      Utils.random = new java.util.Random(1);
      runCommands(
          NEW_GAME + " EASY 2",
          "Alice",
      ...
      assertDoesNotContain(END_GAME.getMessage("Alice", "1"));
      assertDoesNotContain(END_GAME.getMessage("Jarvis", "1"));
      assertContains(PRINT_PLAYER_WINS.getMessage("Alice", "1", "1"));
      assertContains(PRINT_PLAYER_WINS.getMessage("Jarvis", "0", "2"));
      assertDoesNotContain(PRINT_PLAYER_WINS.getMessage("Alice", "0", "0"));
      // SECOND ROUND
      assertTrue(
          MainTest.getOutputByRound(2, getOutput())
              .contains(PRINT_OUTCOME_ROUND.getMessage("HUMAN_WINS")));
